...
');
 ...
 $visitorExcel = new EmailTemplate();
        $visitorExcel->setName('export visitors excel');
        $visitorExcel->setSubject('تصدير ملف الزوار');
        $visitorExcel->setMessage('بناءً على طلبكم وحسب البيانات المطلوبه من النظام, تم الإنتهاء من تصدير ملف الاعضاء<br>
نرجو الضغط على الرابط لتحويلك الى الملف');
        $visitorExcel->setExtraInfo('');

        $visitorExcel->setTemplate('                <tr>
                                                    <td>
