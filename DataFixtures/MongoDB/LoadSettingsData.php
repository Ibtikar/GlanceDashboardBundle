...
class LoadSettingsData implements FixtureInterface {
    ...
    public function load(ObjectManager $manager) {
        ...
        $starsBriefAr->setCategories(array("stars"=>"stars"));
        ...
        $starsBriefEn->setCategories(array("stars" => "stars"));
        ...
        $starsBenefitsAr->setCategories(array("stars"=>"stars"));
        ...
        $starsBenefitsEn->setCategories(array("stars"=>"stars"));
