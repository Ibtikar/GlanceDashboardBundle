...
class Media extends Document {
     ...
     * @Assert\Image(maxSize="4194304", maxSizeMessage="Image size must be less than 4mb", minWidth=1170, minHeight=600, minWidthMessage="Image dimension must be more than 1170*600", minHeightMessage="Image dimension must be more than 1170*600", mimeTypes={"image/jpeg", "image/pjpeg", "image/png"}, mimeTypesMessage="picture extension not correct.", groups={"product"})
