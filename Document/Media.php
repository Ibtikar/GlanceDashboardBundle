...
class Media extends Document {
     ...
     * @Assert\Image(maxSize="4194304", maxSizeMessage="Image size must be less than 4mb", mimeTypes={"image/jpeg", "image/pjpeg", "image/png", "image/gif"}, mimeTypesMessage="picture extension not correct.", groups={"ckeditor"})
