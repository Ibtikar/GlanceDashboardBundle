...
class SitemapGeneratorCommand extends ContainerAwareCommand {
    ...
    protected function addLink($material, $lastmod = null, $changefreq = "daily", $priority = "0.8") {
        ...
        $arr = array(
                'loc' => $this->generateURL('ibtikar_goody_frontend_'.trim($material->getType()).'_view',array('slug' => $this->locale == "en"?$material->getSlugEn():$material->getSlug(),'_locale'=>$this->locale)),
