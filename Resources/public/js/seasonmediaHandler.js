...
function populateData() {
    ...
    $('#media-list-target-right').find('tr').each(function(index) {
        ...
        mediaContainer.push({
            ...
            descriptionAr: typeof $(this).find('.dev-description-ar').val() !== "undefined" ? $(this).find('.dev-description-ar').val() : "",
            descriptionEn: typeof $(this).find('.dev-description-en').val() !== "undefined" ? $(this).find('.dev-description-en').val() : "",
...
function addImageToSortView(selector,media) {
    ...
    selector.append(
        ...
        .replace(/%description-ar%/g, media.descriptionAr?media.descriptionAr:'')
        .replace(/%description-en%/g, media.descriptionEn?media.descriptionEn:'')
    );
