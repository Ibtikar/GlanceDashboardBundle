...
class RecipeType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder
                ...
                ->add('preparationTime', formType\NumberType::class, array('required' => false, 'attr' => array()))
                ->add('cookingTime', formType\NumberType::class, array('required' => false, 'attr' => array()))
                ->add('servingCount', formType\NumberType::class, array('required' => false, 'attr' => array()))
